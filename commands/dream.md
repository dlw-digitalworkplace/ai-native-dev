...
whole run — the curation summary, the config PR body and every parking-lot note, and your own console messages (end the run with its **Done / Needs you / Next** block):
```bash
