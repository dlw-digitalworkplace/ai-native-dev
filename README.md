...
|---|---|:--:|:--:|---|
| Onboarding (pre-flow) | Onboarding agent — `/aind:onboard` | ✅ | ✅ | Three-lens, evidence-only rule discovery (D18); reads existing instruction files first, reads real source to capture deep, enforceable coding + functional conventions, and resolves competing patterns interactively (D44). |
